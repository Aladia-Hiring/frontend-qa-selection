    ...
    <div class="surface">
      ...
      <form @submit.prevent="onSubmit" novalidate>
        <div class="components-div">
          ...
          <!-- Submit button -->
          <div class="component-container">
            <button type="submit" class="enter-button" :disabled="loading">
              Enter
            </button>
          </div>
          ...
          <!-- Social buttons -->
          <div class="component-container">
            <button type="button" class="link-btns" @click="handleGoogleLogin">
          ...
          <div class="component-container">
            <button type="button" class="link-btns" @click="handleFacebookLogin">
              <div class="img-text-cont">
          ...
          <div class="component-container">
            <button type="button" class="link-btns" @click="handleAppleLogin">
              <div class="img-text-cont">
